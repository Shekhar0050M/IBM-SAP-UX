		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Assignment 9",
									"targetURL": "#com.ibm.testapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"com.ibm.testapp-display": {
								"semanticObject": "com.ibm.testapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibm.testapp",
									"url": sap.ui.require.toUrl("com.ibm.testapp")
								}
							}
						}
					}
